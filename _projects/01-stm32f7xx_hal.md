---
title:  "stm32f7xx-hal contribution"
updated: 02/05/2020
excerpt: "Crude artificial horizon on a STM32F7-DISCO board. Contributed to an open-source HAL."
header:
    teaser: /assets/images/projects/stm32f7xx_hal/stm32-rs.jpg
---

For a school project I implemented a crude artificial horizon on a STM32F746-DISCO board. This was the occasion to learn embedded-rust. The code of the Hardware Abstraction Layer (HAL) I contributed to can be found [here](https://github.com/stm32-rs). The code of my crude artificial horizon can be found [here](/assets/images/projects/stm32f7xx_hal/artificial-horizon.zip).

<figure style="width: 10em" class="align-center">
    <img src="/assets/images/projects/stm32f7xx_hal/artificial-horizon.jpg" alt="Digital artificial horizon" class="center">
